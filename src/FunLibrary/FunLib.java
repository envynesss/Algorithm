...
public class FunLib {
    ...
    public static double f1_species_rs = 2; //Function species radius
    ...
    public static double[] f2_gpoint_1 = {0,0};

    //f2 function related data
    public static int f3_codeNum = 3; //Function code number
    public static int f3_Dims = 1; //Function dimension
    public static double f3_species_rs = 0.1; //Function species radius
    public static double f3_maxRange = 1; //Function max Range
    public static double f3_minRange = 0; //Function min Range
    public static double[] f3_gpoint_1 = {0.1};
    public static double[] f3_gpoint_2 = {0.3};
    public static double[] f3_gpoint_3 = {0.5};
    public static double[] f3_gpoint_4 = {0.7};
    public static double[] f3_gpoint_5 = {0.9};
    ...
    public static double funLib(double[] x,int n){
        ...
        switch (n){
            ...
            case 4:
                break;
                /*fitness=Math.pow(Math.E,-Math.pow(x-4,2)-Math.pow(y-4, 2))
                    +Math.pow(Math.E,-Math.pow(x+4,2)-Math.pow(y-4, 2))
                    +2*(Math.pow(Math.E,-Math.pow(x,2)-Math.pow(y, 2))+Math.pow(Math.E,-Math.pow(x,2)-Math.pow(y+4, 2)));*/
        }
        return fitness;
    }
}
